...
Este capítulo desarrolla el plan de trabajo seguido para la ejecución del proyecto, la selección de los cultivos, la unidad de procesamiento central y los componentes del sistema, y la arquitectura mecánica del prototipo (prototipos inicial y final, impermeabilización y drenaje, modularidad, y piezas diseñadas mediante manufactura aditiva).
...
\caption{Vista de la interfaz de control desde el navegador web en una computadora: Formulario de ajuste de parámetros (\texttt{config.toml}). Fuente: Elaboración propia.}
...
\caption{Vista de la interfaz de monitoreo desde el navegador web en una computadora: Gráficos históricos de humedad de suelo e intensidad de luz. Fuente: Elaboración propia.}
...
\caption{Vista de la interfaz de monitoreo desde el navegador web en una computadora: Gráficos históricos de temperatura y humedad ambiente, desplegada mediante el túnel inverso en \url{https://democrat-unrobed-excess.ngrok-free.dev/?success=1}. Fuente: Elaboración propia.}
