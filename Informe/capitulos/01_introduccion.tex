...
El presente proyecto integrador se desarrolla en el marco de las investigaciones del Laboratorio de Investigación Aplicada y Desarrollo (LIADE), orientadas al desarrollo de soluciones tecnológicas aplicadas a la agricultura urbana y periurbana (AUP), un campo de creciente importancia frente al aumento de la urbanización, la reducción de tierras cultivables y la limitación de recursos hídricos y energéticos.En este contexto, se propone el diseño, construcción e implementación de un prototipo\footnote{El código fuente completo del sistema de control desarrollado se encuentra disponible en \cite{repo}.} de granja urbana vertical inteligente, aplicando principios de la Industria 4.0 para el monitoreo y control automatizado de variables críticas de cultivo.
