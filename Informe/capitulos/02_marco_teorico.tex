...
resistencia dependiente de la luz (LDR) caracterizada frente a un luxómetro de referencia, logró estimar el DLI diario con un error relativo medio de apenas \SI{1.78}{\percent} respecto de la medición de referencia \cite{deocampo2017}. Esta estrategia de estimación indirecta (medir lux con un sensor económico y convertirlo a PPFD mediante un factor de luminaria calibrado) es la que 
se adopta en el desarrollo de este trabajo para el control dinámico de la iluminación artificial.
