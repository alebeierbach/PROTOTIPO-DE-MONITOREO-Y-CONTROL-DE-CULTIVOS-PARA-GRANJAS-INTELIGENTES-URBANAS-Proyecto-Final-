...
\section{Protocolo de validacion}
El protocolo de verificación y validación global del Proyecto Integrador se estructuró bajo un enfoque sistémico multivariable, considerando que el éxito del prototipo se demuestra a través de la convergencia armónica de sus diferentes etapas tecnológicas y biológicas. El indicador definitivo de validación lo constituye el rendimiento agronómico y la evolución saludable de los cultivos seleccionados, al ser el objetivo final hacia el cual se orienta la automatización de la granja inteligente. No obstante, para fundamentar analíticamente este resultado, el proceso de comprobación requiere evaluar de forma independiente los siguientes eslabones críticos: en primer lugar, la etapa de adquisición y acondicionamiento digital de las señales físicas; en segundo lugar, la estabilidad dinámica de los lazos de control encargados de regular variables críticas como el fotoperíodo artificial y los ciclos de irrigación hídrica; y en tercer lugar, la interoperabilidad del ecosistema informático en conjunto, auditando la tasa de éxito en la transmisión telemétrica hacia la nube, la disponibilidad de la interfaz gráfica de usuario y la capacidad de escalabilidad topológica para la adición de futuros módulos periféricos de cultivo.
...
\section{Fases de Desaxrrollo del Proyecto}
...
El dimensionamiento de la etapa de potencia del prototipo se rigió por un criterio metodológico defensivo, orientado al aprovechamiento de recursos preexistentes y la reducción de costos de implementación. En lugar de adquirir un módulo de alimentación comercial dedicado, se determinó la viabilidad técnica de reciclar e integrar una fuente conmutada de factor de forma extendido. Esta decisión responde a los principios de la ingeniería aplicada, donde las restricciones financieras se abordan como variables de diseño obligatorias para consolidar arquitecturas eficientes y reproducibles sin incurrir en erogaciones innecesarias. A nivel metodológico, el aparente sobredimensionamiento de la potencia nominal del dispositivo se asume como una redundancia controlada que beneficia la estabilidad del sistema, garantizando la disponibilidad de múltiples canales de tensión independientes y conmutaciones limpias que protegen la lógica de control principal de las perturbaciones eléctricas generadas por los actuadores.
...
\begin{itemize}
    ...
    \item Placa perforada multiproposito.
\end{itemize}
