...
El presente proyecto integrador surge ante la necesidad de desarrollar soluciones tecnológicas aplicadas a la Agricultura Urbana y Periurbana (AUP), un campo aún poco explorado en el ámbito local pero de creciente importancia frente al aumento de la urbanización, la reducción de tierras cultivables y la limitación de recursos hídricos y energéticos. En este marco, se propone el diseño, construcción e implementación de un prototipo de granja urbana vertical inteligente, aplicando principios de la Industria 4.0 para el monitoreo y control automatizado de variables críticas de cultivo.

Este trabajo se desarrolla formalmente dentro del proyecto de investigación del Laboratorio de Investigación Aplicada y Desarrollo Electrónico (LIADE) titulado \textit{“Granjas inteligentes para ciudades inteligentes y sostenibles. Desarrollos de la Industria 4.0 para la gestión de la Agricultura Urbana y Periurbana (AUP) sostenible de ciudades inteligentes”}, con el propósito de cumplir la meta correspondiente al periodo 2025/2026 orientada a la implementación, puesta a punto y validación experimental de un prototipo funcional.
...
En el contexto académico local, en la Facultad de Ciencias Exactas, Físicas y Naturales de la Universidad Nacional de Córdoba existe una línea de desarrollo orientada a la agricultura vertical. Entre los trabajos previos destacados que sirven como cimientos directos para este Proyecto Integrador se encuentran:
\begin{itemize}
...
La relevancia de este trabajo radica en articular tecnologías propias de la Industria 4.0 (sensores integrados, control automatizado por microcontrolador, transmisión y registro continuo de datos) en un prototipo accesible de pequeña escala. Frente al modelo tradicional de producción agrícola, la implementación de sistemas verticales modulados permite:
\begin{itemize}
...
\begin{enumerate}
    \item \textbf{Motivación Técnica e Ingenieril:} El desafío de diseñar integralmente un sistema electrónico que combine sensado de datos, diseño de potencia, desarrollo de firmware optimizado en microcontrolador y lógica de control.
...
\begin{itemize}
    ...
    \item Desarrollar la lógica de control en la unidad central (microcontrolador) para la gestión integral y autónoma del sistema.
...
\begin{enumerate}
    \item \textbf{Fase de Selección y Análisis Agronómico/Tecnológico:} Definición de cultivos modelo, caracterización de rangos ideales de cultivo y selección de sensores, actuadores y microcontrolador priorizando la relación costo-beneficio.
    ...
    \item \textbf{Fase de Desarrollo de Firmware e Integración:} Programación de la lógica de control en microcontrolador, calibración de sensores de humedad de sustrato y temperatura, e integración con circuitos de acondicionamiento y potencia.
...
\begin{itemize}
    \item En primer lugar, se establece el \textbf{Marco Teórico y Estado del Arte}, donde se abordan los conceptos agronómicos fundamentales de la agricultura vertical, los principios de la Industria 4.0 y las bases de control e instrumentación electrónica aplicadas.
    
    \item A continuación, se detalla el \textbf{Marco Metodológico y Criterios de Selección}, exponiendo la justificación técnica detrás de la elección de los cultivos modelo, los sensores, actuadores y la unidad de procesamiento central.
    
    \item Posteriormente, se aborda el \textbf{Diseño e Implementación del Hardware}, describiendo la construcción de la estructura modular, los circuitos de acondicionamiento, la etapa de potencia y el montaje de los subsistemas de riego, iluminación y ventilación.
    
    \item Luego, se expone el \textbf{Desarrollo del Firmware y Lógica de Control}, detallando la arquitectura de software del microcontrolador, los algoritmos de control automático implementados y las estrategias de optimización de código.
    
    \item Finalmente, se presentan los \textbf{Resultados Experimentales, Conclusiones y Trabajos Futuros}, analizando las mediciones recolectadas en condiciones reales de cultivo, evaluando la eficiencia del sistema y proponiendo líneas de continuidad para el proyecto.
\end{itemize}
